  ...
  return (
    <div className="materialSearch">
      ...
      <div className="materialSearchInputWrap">
        ...
        <input id="material-search-input" type="search" value={query} onChange={event => onQueryChange(event.target.value)} placeholder="Наприклад, tkus 25x25" autoComplete="off" spellCheck="false" />
      </div>
      {query.trim() ? (
