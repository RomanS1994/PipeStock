          ...
          <div className="dashboardBrandRow">
            ...
            {showWorkTrackReturn ? (
              <a className="dashboardWorkTrackReturn" href="/partners" onClick={() => window.sessionStorage.removeItem(RETURN_CONTEXT_KEY)} aria-label="Повернутися до WorkTrack">
                <svg className="dashboardWorkTrackArrow" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7"/><path d="M5 12h14"/></svg>
                <img className="dashboardWorkTrackIcon" src={assetPath('/assets/worktrack-icon.svg')} alt="" aria-hidden="true" />
                <span>WorkTrack</span>
              </a>
            ) : null}
          </div>
